...
import com.shashank.mentalhealth.audiovisualizer.visualizer.BarVisualizer;
...
public class MusicFragment extends Fragment {
    ...
    int[] links = {R.raw.music1, R.raw.music2, R.raw.music3};
...
//            Toast.makeText(getContext(), "length="+length+" "+"duration="+duration, Toast.LENGTH_SHORT).show();
            if (mediaPlayer == null) {
                try {
                    ...
                    new Thread(() -> {
                        mediaPlayer = MediaPlayer.create(getContext(), getCurrentLink()); //peace music
